...
import CustomBreadCrumb from "./custome-bread-crumb";
...
const formSchema = z.object({
  ...
  description: z.string().min(10, "Description is required (Min 10 words)"),
  experience: z.coerce
    .number()
...
const FormMockInterview = ({ initialData }: FormMockInterviewProps) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast("Error..", {
        description: "Failed to delete the mock interview.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
